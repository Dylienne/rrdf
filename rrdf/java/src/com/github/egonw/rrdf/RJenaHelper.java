...
public class RJenaHelper {
    ...
    throws Exception {
        Resource subjectRes = subject==""? model.createResource() : model.createResource(subject);
        Property propertyRes = model.createProperty(property);
        Resource objectRes = object ==""? model.createResource() : model.createResource(object);
    ...
    public static Resource createResource(Model model, String URI){
    ...
    public static Property createProperty(Model model, String URI){
        Property property = model.createProperty(URI);
        return property;
    }
    public static void addObjectProperty(Model model, Resource subject, Property property, Resource object){
